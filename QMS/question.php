...
$sql ="insert into `question_bank` (Question_ID,Quiz_ID,Question,Choice_1,Choice_2,Choice_3,Choice_4,Answer)
value('$queid','$qid','$que','$ch1','$ch2','$ch3','$ch4','$ans')";
...
<div class="row">
<div class="col-md-4"><b>Question ID</b>
<input type="text" name="queid" class="form-control" maxlength="10" required>
</div>
