...
<tbody>
<?php
$sql = "select Quiz_ID, Quiz_name, Section_name, Provider_name, Duration
 from Quiz q, Section s, Quiz_Provider p
...
?>
<tr>
<td><?php echo htmlentities($result['Quiz_ID']);?></td>
<td><?php echo htmlentities($result['Quiz_name']);?></td>
...
<td><a href="upd_quiz.php?id=<?php echo
htmlentities($result['Quiz_ID']);?>"><button class="btn btn-primary btnxs">Update</button></a></td>
</tr>
<?php
} } else { ?>
<tr>
