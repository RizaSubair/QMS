...
<div class="row">
<div class="col-md-2">
<a href="add_provider.php"><button class="btn btn-primary"> Add Provider</button></a>
</div>
<div class="col-md-2">
<a href="add_section.php"><button class="btn btn-primary"> Add Section</button></a>
</div>
</div>
...
<input type="number_format" name="time" class="form-control" placeholder="in minutes" required>
</div>
</div>
<div class="row">
</div>
